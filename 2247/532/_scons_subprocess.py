...
if mswindows:
    ...
    # SCons compatibility change:  the original subprocess code here
    # always tries to use the internal _subprocess module.  Since
    # the point of this layer is to support earlier Python versions
    # that don't have the subprocess module, the _subprocess module
    # should never be there if we import this module.  So:  always
    # use the pywin32 modules.
